...
class CVAE(nn.Module):
    def __init__(self,
        ...
        # Encoder
        self.encoder = nn.LSTM(input_size=self.params_num_chord + self.BEAT_RESOLUTION * 25 + self.params_prenet_size * 4, 
        ...
        # Latent to decoder
        self.latent2decoder_input = nn.Linear(self.params_latent_size + self.BEAT_RESOLUTION * 25 + self.params_prenet_size * 4, self.params_decoder_hidden_size // 2,device=self.device)
